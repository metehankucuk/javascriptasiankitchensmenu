...
for (let index = 0; index < categoryArray.length; index++) {
  ...
  button.innerText = categoryArray[index]
  ...
  button.addEventListener("click", function () {
    switch(button.innerText){
      case "All":
        ...
        break;
      case "Korea":
        menuList(menu.filter(item => item.category == "Korea"))
        break;
      case "China":
        menuList(menu.filter(item => item.category == "China"))
        break;
      case "Japan":
        menuList(menu.filter(item => item.category == "Japan"))
        break;
    }
  }
  )
